---
title: "Analyzing Residual Plots"
output:
...
Yikes. This is not a good plot at all. A significant portion of the data leaves the confidence band. The errors are not normally distributed. Assumption #3 is not met.

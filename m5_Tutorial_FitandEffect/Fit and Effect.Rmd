...
So we want to try and avoid both too many, and not too few predictor variables.  To balance the tendancy of $R^2$ to increase as we add more variables we use the adjusted-$R^2$.  You saw the formula in your reading, and you will notice the formula takes into account the number of predictors we are using relative to the number of data points we have.
